...
public class Main {
    ...
    private static final double POLICE_TRAFFIC_MEAN = 0.9;
    private static final double THIEF_TRAFFIC_MEAN = 1;
    private static final double STANDARD_DERIVATION = 0.0;
